...
bool init_text()
{
	FILE* fp = fopen(kFontPath, "rb"); if (!fp) { printf("%s(): Unable to open %s\n", __func__, kFontPath); return false; }
	...
	program_text = cg_create_program(kVertexTextPath, kFragmentTextPath);
